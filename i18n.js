(function () {
  ...
  var dictionary = {
    en: {
      ...
      themeLight: "Light",
      themeDark: "Dark",
      heroEyebrow: "media automation • B2B content • scroll landings",
      heroTitle: "Content, automation and premium product pages — without manual routine.",
      heroText:
        "Channel grids and auto-publishing — plus cinematic scroll landings: AI images → video → product disassembly on scroll. From idea to GitHub Pages deploy.",
      heroWork: "See Work",
      heroCv: "Resume / CV",
      heroPdf: "Download PDF",
      metricWorkstations: "channels in the grid",
      metricRegistry: "registry records in one project",
      metricDevops: "scroll landings in portfolio",
      metricDeploy: "images → video → site",
      showcaseKicker: "Cases",
      showcaseTitle: "Royal Pop scroll landings — cinematic disassembly on scroll.",
      showcaseText:
        "API generates images → pipeline builds video → site scrubs MP4 natively. No heavy React, fast on GitHub Pages.",
      showcaseAxisText:
        "Cinematic hardware disassembly: circle-wipe, callouts, stats, native H.264 scroll-scrub.",
      showcaseAxisLink: "Code on GitHub →",
      showcaseNexusText:
        "Scroll-driven explode on Canvas 2D — no video, 192 frames synthesized at runtime.",
      showcaseNexusLink: "Code on GitHub →",
